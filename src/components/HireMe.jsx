    ...
    <section className="py-5 text-white" style={{ backgroundColor: '#0d6efd' }}>
      <Container className="text-center">
        ...
        <Row className="justify-content-center">
          <Col xs="auto">
            <a href={`${process.env.PUBLIC_URL}/Srikaran_R_S_Resume.pdf`} target="_blank" rel="noopener noreferrer">
              <Button variant="light" className="me-3 px-4">
                View Resume
              </Button>
            </a>
            <a href={`${process.env.PUBLIC_URL}/Srikaran_R_S_Resume.pdf`} download>
